...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
	...
	return (
		<div className='w-full bg-background font-sans lg:px-10' ref={containerRef}>
			<div ref={ref} className='relative max-w-7xl mx-auto pb-20'>
				{data.map((item, index) => (
					...
					>
						<div className='sticky flex flex-col lg:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm lg:w-1/3 lg:shrink-0'>
							...
							<h3 className='hidden lg:block text-xl lg:pl-20 lg:text-3xl font-bold text-neutral-500 dark:text-neutral-500 '>
								{item.title}
							</h3>
						</div>

						<div className='relative min-w-0 pl-16 pr-0 lg:pl-4 lg:pr-4 w-full'>
