...
export const SectionTechStack = ({
	...
	return (
		<section
			className={cn('py-20 mb-24', className)}
			{...rest}
		>
				...
				{TechStackData.map((category, index) => (
					...
					>
						...
						<div className={cn(
							...
							activeCategory === category.name ? "border-accent shadow-xl" : "border-border/50"
						)}>
							...
							<div className="relative z-10">
								...
								<div className="flex items-center justify-between mb-6 gap-2">
									...
									<span className={cn(
										...
										activeCategory === category.name && "bg-accent text-white"
									)}>
								...
								{category.techs.length > 8 && (
									<div className="mt-3 text-center">
										<HoverCard openDelay={200} closeDelay={100}>
											...
											<HoverCardContent className="w-auto p-3" align="center" sideOffset={5}>
												<motion.div
