...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return generateWidgetMetadata('text-counter', locale as 'en' | 'ru' | 'he')
}
...
export default async function Layout({
  ...
  const url = `${BASE_URL}/${locale}/projects/text-counter`
  
  return (
    <>
      <WidgetSchema
        name="Text Counter & Analyzer"
        description="Count characters, words, paragraphs and analyze text statistics for SEO and social media optimization"
        url={url}
      />
      {children}
    </>
