...
export default function PomodoroTimerPage() {
  ...
  const [editingSettings, setEditingSettings] = useState<TimerSettings>(settings)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="text-center">
                <div className={`text-7xl font-mono font-bold ${getSessionColor()}`}>
                  {formatTime(timeLeft)}
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="soundEnabled" className="flex items-center gap-2">
                      {editingSettings.soundEnabled ? <Volume2 className="w-4 h-4" /> : <VolumeX className="w-4 h-4" />}
                  ...
                  <div className="flex items-center justify-between">
                    <Label htmlFor="showNotifications" className="flex items-center gap-2">
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-muted-foreground">{t('goals.goal')}</span>
